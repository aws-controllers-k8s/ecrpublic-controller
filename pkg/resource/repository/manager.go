...
// +kubebuilder:rbac:groups=ecrpublic.services.k8s.aws,resources=repositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecrpublic.services.k8s.aws,resources=repositories/status,verbs=get;update;patch
